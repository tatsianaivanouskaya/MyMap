...
package com.example.mymap.location;
...
public class Details {
    ...
    @Expose
    private Integer stationGmtOffset;
    ...
    public Integer getStationGmtOffset() {
        return stationGmtOffset;
    }

    public void setStationGmtOffset(Integer stationGmtOffset) {
